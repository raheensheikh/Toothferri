...
<section class="indexSection1 profile_edit">
    <p class="title mb-3">Edit Profile</p>
    <div class="row">
        <div class="qr_scan">
            <div class="selection-btns">
                ...
                <div class="range-wrapper">
                    ...
                    <div id="slider-container">
                        <input type="range" id="range-slider" min="0" max="100" step="1" value="30">
                ...
                <div class="selection-btns">
                    <a href="create-profile.php" class="cta red">Continue</a>
                </div>
            </div>
        </div>
    </div>
